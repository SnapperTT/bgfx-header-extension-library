...
static const uint8_t * vs_cascading_shadow_map_vsm_bin_dx9 = NULL;
unsigned int vs_cascading_shadow_map_vsm_bin_dx9_size = 0;

BX_UNUSED(vs_cascading_shadow_map_vsm_bin_dx9)
BX_UNUSED(vs_cascading_shadow_map_vsm_bin_dx9_size)
static const uint8_t * vs_cascading_shadow_map_vsm_bin_dx11 = NULL;
unsigned int vs_cascading_shadow_map_vsm_bin_dx11_size = 0;

BX_UNUSED(vs_cascading_shadow_map_vsm_bin_dx11)
BX_UNUSED(vs_cascading_shadow_map_vsm_bin_dx11_size)
static const uint8_t * vs_cascading_shadow_map_vsm_bin_metal = NULL;
unsigned int vs_cascading_shadow_map_vsm_bin_metal_size = 0;

BX_UNUSED(vs_cascading_shadow_map_vsm_bin_metal)
BX_UNUSED(vs_cascading_shadow_map_vsm_bin_metal_size)
static const uint8_t * vs_cascading_shadow_map_vsm_bin_spirv = NULL;
unsigned int vs_cascading_shadow_map_vsm_bin_spirv_size = 0;
