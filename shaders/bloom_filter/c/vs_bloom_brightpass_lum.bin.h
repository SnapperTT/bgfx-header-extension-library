...
unsigned int vs_bloom_brightpass_lum_bin_glsl_size = 311;
...
static const uint8_t * vs_bloom_brightpass_lum_bin_spirv = NULL;
unsigned int vs_bloom_brightpass_lum_bin_spirv_size = 0;
