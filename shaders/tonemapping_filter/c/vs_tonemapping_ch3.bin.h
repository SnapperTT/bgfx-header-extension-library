...
unsigned int vs_tonemapping_ch3_bin_glsl_size = 311;
...
static const uint8_t * vs_tonemapping_ch3_bin_spirv = NULL;
unsigned int vs_tonemapping_ch3_bin_spirv_size = 0;
