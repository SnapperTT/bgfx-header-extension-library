...
unsigned int vs_tonemapping_ch2_bin_glsl_size = 311;
...
static const uint8_t * vs_tonemapping_ch2_bin_spirv = NULL;
unsigned int vs_tonemapping_ch2_bin_spirv_size = 0;
