static const uint8_t vs_tonemapping_bin_glsl[] = {
...
unsigned int vs_tonemapping_bin_glsl_size = 315;

BX_UNUSED(vs_tonemapping_bin_glsl)
BX_UNUSED(vs_tonemapping_bin_glsl_size)
static const uint8_t * vs_tonemapping_bin_dx9 = NULL;
unsigned int vs_tonemapping_bin_dx9_size = 0;

BX_UNUSED(vs_tonemapping_bin_dx9)
BX_UNUSED(vs_tonemapping_bin_dx9_size)
static const uint8_t * vs_tonemapping_bin_dx11 = NULL;
unsigned int vs_tonemapping_bin_dx11_size = 0;

BX_UNUSED(vs_tonemapping_bin_dx11)
BX_UNUSED(vs_tonemapping_bin_dx11_size)
static const uint8_t * vs_tonemapping_bin_metal = NULL;
unsigned int vs_tonemapping_bin_metal_size = 0;

BX_UNUSED(vs_tonemapping_bin_metal)
BX_UNUSED(vs_tonemapping_bin_metal_size)
static const uint8_t vs_tonemapping_bin_spirv[] = {
  0x56, 0x53, 0x48, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x6f, 0x1e, 0x3e, 0x3c, 0x01, 0x00, 0x0f, 0x75,  // VSH.....o.><...u
...
unsigned int vs_tonemapping_bin_spirv_size = 1096;

BX_UNUSED(vs_tonemapping_bin_spirv)
BX_UNUSED(vs_tonemapping_bin_spirv_size)
static const uint8_t * vs_tonemapping_bin_esslandroid = NULL;
unsigned int vs_tonemapping_bin_esslandroid_size = 0;

BX_UNUSED(vs_tonemapping_bin_esslandroid)
BX_UNUSED(vs_tonemapping_bin_esslandroid_size)
static const uint8_t * vs_tonemapping_bin_pssl = NULL;
unsigned int vs_tonemapping_bin_pssl_size = 0;

BX_UNUSED(vs_tonemapping_bin_pssl)
BX_UNUSED(vs_tonemapping_bin_pssl_size)
static const uint8_t * vs_tonemapping_bin_esslnacl = NULL;
unsigned int vs_tonemapping_bin_esslnacl_size = 0;

BX_UNUSED(vs_tonemapping_bin_esslnacl)
BX_UNUSED(vs_tonemapping_bin_esslnacl_size)
