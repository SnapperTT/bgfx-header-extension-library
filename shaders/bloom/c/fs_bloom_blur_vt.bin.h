...
static const uint8_t * fs_bloom_blur_vt_bin_dx9 = NULL;
unsigned int fs_bloom_blur_vt_bin_dx9_size = 0;

BX_UNUSED(fs_bloom_blur_vt_bin_dx9)
BX_UNUSED(fs_bloom_blur_vt_bin_dx9_size)
static const uint8_t * fs_bloom_blur_vt_bin_dx11 = NULL;
unsigned int fs_bloom_blur_vt_bin_dx11_size = 0;

BX_UNUSED(fs_bloom_blur_vt_bin_dx11)
BX_UNUSED(fs_bloom_blur_vt_bin_dx11_size)
static const uint8_t * fs_bloom_blur_vt_bin_metal = NULL;
unsigned int fs_bloom_blur_vt_bin_metal_size = 0;
