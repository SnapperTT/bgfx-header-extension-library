...
unsigned int fs_untextured_passthrough_color_bin_glsl_size = 106;
...
unsigned int fs_untextured_passthrough_color_bin_dx11_size = 265;
...
unsigned int fs_untextured_passthrough_color_bin_metal_size = 394;
...
unsigned int fs_untextured_passthrough_color_bin_spirv_size = 589;
