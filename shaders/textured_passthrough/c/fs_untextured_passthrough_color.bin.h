...
static const uint8_t fs_untextured_passthrough_color_bin_dx9[] = {
...
unsigned int fs_untextured_passthrough_color_bin_dx9_size = 261;

BX_UNUSED(fs_untextured_passthrough_color_bin_dx9)
BX_UNUSED(fs_untextured_passthrough_color_bin_dx9_size)
...
static const uint8_t * fs_untextured_passthrough_color_bin_esslandroid = NULL;
unsigned int fs_untextured_passthrough_color_bin_esslandroid_size = 0;

BX_UNUSED(fs_untextured_passthrough_color_bin_esslandroid)
BX_UNUSED(fs_untextured_passthrough_color_bin_esslandroid_size)
