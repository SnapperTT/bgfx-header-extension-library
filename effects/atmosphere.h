...
namespace bgfxh
{
  LZZ_INLINE void atmosphericEffect::submit ()
                              {
...
#ifdef BGFXH_IMPL
#ifndef BGFXH_DOUBLE_GUARD_effects_atmosphere
#define BGFXH_DOUBLE_GUARD_effects_atmosphere
// atmosphere.cpp
//
...
#undef LZZ_INLINE
#endif //BGFXH_DOUBLE_GUARD_effects_atmosphere
#endif //BGFXH_IMPL
