...
namespace bgfxh
{
  class cascadingShadowMapRenderJob : public renderJob
  {
  public:
...
namespace bgfxh
{
  LZZ_INLINE void cascadingShadowMapRenderJob::submit (uint32_t const level)
                                                  {
...
namespace bgfxh
{
  cascadingShadowMapRenderJob::cascadingShadowMapRenderJob ()
                                       { initToZero(); }
}
namespace bgfxh
{
...
namespace bgfxh
{
  bgfx::FrameBufferHandle cascadingShadowMapRenderJob::getOutputFrameBuffer (unsigned int const csmLevel) const
                                                                                         { return m_shadowMapFB[csmLevel]; }
}
namespace bgfxh
{
  bgfx::TextureHandle cascadingShadowMapRenderJob::getOutputTexture (unsigned int const csmLevel) const
...
namespace bgfxh
{
  bgfx::FrameBufferHandle cascadingShadowMapRenderJob::getOutputFrameBuffer () const
                                                              { return getOutputFrameBuffer(0); }
}
namespace bgfxh
{
  bgfx::TextureHandle cascadingShadowMapRenderJob::getOutputTexture () const
                                                      { return getOutputTexture(0); }
}
namespace bgfxh
{
  int cascadingShadowMapRenderJob::getViewIncrement () const
                                      { return nShadowLevels; }
}
namespace bgfxh
{
  void cascadingShadowMapRenderJob::initToZero ()
                           {
...
namespace bgfxh
{
  void cascadingShadowMapRenderJob::init ()
                     {
		...
		BGFXH_CHECK(bgfx::isValid(m_programDepthWrite), "failed to load shader bgfxh::cascadingShadowMapRenderJob::m_programDepthWrite! Check your bgfxh::shaderSearchPath setting, path, and that the shader type matches the renderer type!");
		inited = true;
		}
}
namespace bgfxh
{
  void cascadingShadowMapRenderJob::deInit ()
                       {
		for (unsigned int i = 0; i < BGFXH_MAX_SHADOW_LEVELS; ++i) {
...
namespace bgfxh
{
  void cascadingShadowMapRenderJob::setupViews (float * viewMtx, float * projMtx, bx::Vec3 const & lightDirection, float const FOV_H_DEG, float const FOV_V_DEG)
                                                                                                                                          {
...
namespace bgfxh
{
  bool cascadingShadowMapRenderJob::isObjectInShadowVolume (bx::Vec3 const & _pos, float const radius, unsigned int const csmLevel)
                                                                                                             {
...
namespace bgfxh
{
  float cascadingShadowMapRenderJob::internal_sqDistPointAabb (bx::Vec3 const & point, bx::Vec3 const & aabbMin, bx::Vec3 const & aabbMax)
                                                                                                                    {
...
namespace bgfxh
{
  void cascadingShadowMapRenderJob::bindSamplers (unsigned int shadowSampler0)
                                                        {
...
namespace bgfxh
{
  void cascadingShadowMapRenderJob::setLightMVP (float const * modelMtx)
                                                  {
		for (unsigned int csmLevel = 0; csmLevel < nShadowLevels; ++csmLevel) {
			float mvp_shadow[16];
