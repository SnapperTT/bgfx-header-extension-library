...
#	undef  BGFXH_EMBEDDED_SHADER_ESSL
	...
	#else
	#	define BGFXH_EMBEDDED_SHADER_ESSL(_renderer, _name) 			{ _renderer, BX_CONCATENATE(_name, _essl), BX_CONCATENATE(_name, _essl_size) },
	#endif // BGFXH_GOOGLE
...
#define BGFXH_EMBEDDED_SHADER(_name)                                                               			{                                                                                      				#_name,                                                                            				{                                                                                  					BGFXH_EMBEDDED_SHADER_PSSL (bgfx::RendererType::Agc,        _name)             					BGFXH_EMBEDDED_SHADER_DXBC (bgfx::RendererType::Direct3D11, _name)             					BGFXH_EMBEDDED_SHADER_DXBC (bgfx::RendererType::Direct3D12, _name)             					BGFXH_EMBEDDED_SHADER_PSSL (bgfx::RendererType::Gnm,        _name)             					BGFXH_EMBEDDED_SHADER_METAL(bgfx::RendererType::Metal,      _name)             					BGFXH_EMBEDDED_SHADER_NVN  (bgfx::RendererType::Nvn,        _name)             					BGFXH_EMBEDDED_SHADER_ESSL (bgfx::RendererType::OpenGLES,   _name)             					BGFXH_EMBEDDED_SHADER_GLSL (bgfx::RendererType::OpenGL,     _name)             					BGFXH_EMBEDDED_SHADER_SPIRV(bgfx::RendererType::Vulkan,     _name)             					{ bgfx::RendererType::Noop,  (const uint8_t*)"VSH\x5\x0\x0\x0\x0\x0\x0", 10 }, 					{ bgfx::RendererType::Count, NULL, 0 }                                         				}                                                                                  			}
